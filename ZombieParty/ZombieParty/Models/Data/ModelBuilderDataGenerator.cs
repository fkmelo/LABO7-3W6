    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Minazuki", Description = "Le bankai d'uhonhana", Force = 400, Image = "https://publicdomainvectors.org/photos/Shield-ClassicMedieval1.png", Price = 800, Qty = 5, QtyBought = 1, CreatedDate = new DateTime(1999, 01, 1) }
            );
            #endregion
        }
    }
